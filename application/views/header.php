...
<head>
    ...
    <link rel="stylesheet" href="<?php echo site_url('assets/css/dropdown.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/css/etatFinancier.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/css/jsform.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/css/c6form.css'); ?>">
...
<body>
    ...
    font-size: larger;
">
                                        <a href="<?php echo site_url('acceuil/index') ?>" style="
    font-size: 92%;
    margin-left: -380%;
">
                                            acceuil

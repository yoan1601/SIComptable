            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0"><?php echo $identite["nom"] ?></h4>
              ...
              <div class="card-body">
                <form role="form" method="POST" action="login/checkLogin" class="text-start">
                  ...
                  <!--<p class="mt-4 text-sm text-center">
                    ...
                    <a href="login/inscription" class="text-primary text-gradient font-weight-bold">S'inscrire</a>
                  </p>-->
                </form>
              </div>
            </div>
